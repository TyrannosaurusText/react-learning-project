...
var _Overlay = _interopRequireDefault(
  require("../../node_modules/react-bootstrap/Overlay")
);
  ...
  (function(_React$Component2) {
    ...
    function OverlayTrigger(props, context) {
      ...
      _this.handleBlur = function(e) {
        _this.unlock();
        console.log(_this.props.overlay)
        // _this.handleHide(e);
      };
    ...
    _proto2.getOverlayProps = function getOverlayProps() {
      return _react.default.Children.only(this.props.overlay).props;
    };
    ...
    _proto2.handleMouseOverOut = function handleMouseOverOut(
      ...
      if (
        ...
        !(0, _contains.default)(target, related)
      ) {
        handler(e);
      }
    };
    ...
    _proto2.lock = function lock() {
      this.setState({
        lock: true
      });
    };
    _proto2.unlock = function unlock() {
      this.setState({
        lock: false
      });
    };
